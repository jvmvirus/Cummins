...
simFla.ux.plugins.signaturePad = Ext.extend(Ext.util.Observable, {
 ...
 init: function(cmp){
    this.cmp = cmp;
    cmp.on('initialize', this.initControl, this);
  ...
  initCanvas: function(){
      ...
      if (oCanvas) {
         ...
         oCanvas.onmousedown = function(e) {
                 bMouseIsDown = true;                 
                 iLastX = e.clientX - simFla.ux.plugins.getXPos(panel.element.dom);
                 iLastY = e.clientY - simFla.ux.plugins.getYPos(panel.element.dom);
         }
         ...
         oCanvas.onmousemove = function(e) {
                 if (bMouseIsDown) {
                         var iX = e.clientX - simFla.ux.plugins.getXPos(panel.element.dom);
                         var iY = e.clientY - simFla.ux.plugins.getYPos(panel.element.dom);
